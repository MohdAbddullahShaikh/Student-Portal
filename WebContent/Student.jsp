...
<%@page import="com.sterling.dto.StudentResult"%>
...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	List<StudentResult> srult = sd.getAllResult();
						...
						<div class="col-md-4">
							...
							<div class="col-md-4">
								<div
									class="card text-center cards shadow p-3 mb-5 bg-body rounded"
									style="width: 18rem;" data-bs-toggle="modal"
									data-bs-target="#downloadresultmodal">
									<div class="card-body">
...
<div class="col-md-2"></div>
	...
	<div class="modal fade" id="downloadresultmodal"
		data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-scrollable modal-lg">
			<div class="modal-content">
		...
		<div class="accordion accordion-flush" id="accordionFlushExample">
						<div class="accordion-item">
							<h2 class="accordion-header" id="panelsStayOpen-heading<%=b%>">
								...
								<button class="accordion-button collapsed" type="button"
									data-bs-toggle="collapse"
									data-bs-target="#panelsStayOpen-collapse<%=b%>"
									aria-expanded="false"
									aria-controls="panelsStayOpen-collapse<%=b%>">
									<%=s.getFileName()%></button>
							</h2>
							<div id="panelsStayOpen-collapse<%=b%>"
								class="accordion-collapse collapse"
								aria-labelledby="panelsStayOpen-heading<%=b%>">
								<div class="accordion-body">
